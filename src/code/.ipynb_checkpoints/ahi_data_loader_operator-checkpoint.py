...
@md.input("json_file", DataPath, IOType.DISK)
...
class AHIDataLoaderOperator(Operator):
    ...
    def load_data_to_studies(self, input_path: string):
        ...
        dicom_studies = self._load_data(data)
...
def test():
    ...
    data_path = current_file_dir.joinpath("./dcm")
